    ...
    public class CryptoTradeContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, Name = "Mario", Birthdate = new DateTime(2001, 1, 1), Email = "mario@gmail.com", Password = "mario12345", Phone = "4574", DNI = "32452464D", Nationality = "España", Cash = 500, Wallet = 300, Role = Roles.Admin},
                new User { Id = 2, Name = "Carlos", Birthdate = new DateTime(2003, 3, 3), Email = "carlos@gmail.com", Password = "carlos12345", Phone = "4567477", DNI = "23523562D", Nationality = "Argentina", Cash = 400, Wallet = 750 },
